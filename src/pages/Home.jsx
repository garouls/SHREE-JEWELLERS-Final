      ...
      <div className="gold-ticker-bar">
        <div className="ticker-content-wrapper">
          <div className="ticker-items">
            ...
            <span className="ticker-item" style={{ fontWeight: 700, color: 'var(--royal-gold)' }}>HARDIK JEWELLERS:</span>
        ...
        <div className="nav-container">
          ...
          <a href="#" className="nav-brand" style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            <div className="brand-text-container">
              <span className="brand-name">HARDIK JEWELLERS</span>
              ...
              <div>
                ...
                <div className="polaroid-frame polaroid-left">
                  ...
                  <div className="polaroid-caption">
                    ...
                    <span className="caption-sub">HARDIK JEWELLERS Heritage</span>
                  </div>
                </div>
              </div>
                ...
                <div className="product-image-outer">
                  <div className="product-image-inner">
                    ...
                    <div className="product-card-hover-overlay">
                      ...
                      <a 
                        href={`https://wa.me/919892911531?text=Hello%20HARDIK%20Jewellers,%20I%20am%20interested%20in%20buying%20your%20${encodeURIComponent(product.title)}`}
                        target="_blank"
                        rel="noreferrer"
          ...
          {filteredProducts.length === 0 && (
            <div className="custom-order-box">
              ...
              <p className="custom-order-desc">
                We craft bespoke handcrafted pieces matching your specifications for {activeCategory}. Please contact our ULHASNAGAR showroom on WhatsApp to design your dream piece.
              </p>
              <a 
        ...
        <div className="section-inner">
          <div className="contact-grid">
            ...
            <div className="contact-form-block">
              ...
              <form onSubmit={(e) => { e.preventDefault(); alert("Thank you! Our ULHASNAGAR showroom representative will reach out to you shortly."); }} className="contact-form">
      ...
      <footer className="footer-main">
        <div className="footer-inner">
          ...
          <div className="footer-socials">
            ...
            <a href="https://www.instagram.com/hardikjewellers_?igsh=MWM2dXM5ZG8ydGF3bg==" target="_blank" rel="noreferrer" className="instagram-circle-btn" aria-label="Instagram">
